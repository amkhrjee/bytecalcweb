...
const buttonsWrapper = document.querySelector(".buttons") as HTMLDivElement;
const buttons = document.querySelectorAll(
  ".buttons>*"
) as NodeListOf<MdFilledButton>;
const firstRowButtons = document.querySelectorAll(
  ".op-buttons>*"
) as NodeListOf<MdTextButton>;
const hiddenRowButtons = document.querySelectorAll(
  ".hidden-ops>md-filled-button"
) as NodeListOf<MdFilledButton>;
const inputArea = document.querySelector(".numinput") as HTMLInputElement;
const menuButton = document.querySelector(".menu-btn") as MdIconButton;
const copyButton = document.querySelector(
  ".output-display-wrapper>md-icon-button"
) as MdIconButton;
const toggleButton = document.querySelector(
  "md-filled-tonal-icon-button"
) as MdFilledTonalIconButton;
const opButtons = document.querySelector(".op-buttons") as HTMLButtonElement;
const hiddenOps = document.querySelector(".hidden-ops") as HTMLDivElement;
const display = document.querySelector(".display") as HTMLDivElement;
const firstRow = document.querySelector(".first-row") as HTMLDivElement;
const navDrawer = document.querySelector(".menu") as HTMLDivElement;
const supportButton = document.querySelector(
  ".support-btn"
) as MdOutlinedButton;
const supportDialog = document.querySelector(".support-dialog") as MdDialog;
const supportDialogCloseButton = document.querySelector(
  ".support-dialog-close-btn"
) as MdTextButton;
const commitDate = document.querySelector(".commit-date") as HTMLSpanElement;
const changeThemeButton = document.querySelector(
  ".change-theme-btn"
) as HTMLButtonElement;
const themeDialog = document.querySelector(".theme-dialog") as MdDialog;
...
const showOutput = (message: string, isError: boolean) => {
...
document.forms["theme"].addEventListener("change", (e: Event) => {
  console.log((e.target as MdRadio).value);
  console.log("In the form!");
  const selectedTheme = (e.target as MdRadio).value;
